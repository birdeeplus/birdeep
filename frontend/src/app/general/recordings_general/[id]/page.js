...
export default function RecordingDetails() {
    ...
    return (
        <div className="relative w-full h-screen">
            <Navbar toggleLanguage={toggleLanguage} language={language} />  {/* Pasa la función de cambio de idioma al Navbar */}
            <div className="container mx-auto px-10 flex flex-col items-center h-full py-10">
                ...
                >
                    {textContent[language].backToRecordings}  {/* Botón en función del idioma */}
                </button>
            </div>
        </div>
    );
