...
from controllers.locations_controller import insert_new_location, query_locations, update_location, delete_location, get_location_by_id
...
locations_bp.add_url_rule('/api/v1/locations/<int:id_location>', view_func=get_location_by_id, methods=['GET'])